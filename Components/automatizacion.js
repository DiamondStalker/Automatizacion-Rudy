...
const Auto = {
    async run(lista) {
        ...
        if (loggin == true) {
            ...
            for (let elem of lista) {
                ...
                try {
                    ...
                    /* -------------------------------------------------------------------------- */
                    /*                      Ckick al boton de enviar mensage                      */
                    /* -------------------------------------------------------------------------- */

                    await page.click('[id="send-sms"]');
                    ...
                    await page.waitForSelector('#vs4__combobox > div.vs__selected-options > input');
                    await page.fill('#vs4__combobox > div.vs__selected-options > input', elem["Template What"].toString().trim());
                    await page.waitForTimeout(500);
                    ...
                    await page.click('#send-sms');
                    await page.waitForTimeout(1500);


                    await page.reload();
                    await page.waitForSelector('[meta="dashboard"]');
                    await page.waitForTimeout(3000);

                } catch (e) {
                    await console.log(e);
                    await console.log(`El telefono ${elem.Telefono} ya no se encuentra disponible....`)
                    listError.push(elem.Telefono);
                }
        ...
        await File.listaErrores(listError);
